# 雪梛のブログ
多趣味なのでいろいろなことを気ままに文字に起こして記事にしています。<br>
Astroで構築し、Vercelでホスティングしています。<br>
このサイトは、Claude(Anthropic社のAI)とコードを書きながら運営しています。<br>
...
---
不具合報告や「ここもっとこうしたら?」みたいな提案も歓迎です。<br>
